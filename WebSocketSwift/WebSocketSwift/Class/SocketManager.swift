...
class WebSocketManager: NSObject {
    ...
    func connectSocket(_ paremeters: Any?) {
        guard let url = URL(string: "ws://newlive.ofweek.com/api/web/ws/webSocket?param=byRcb7NFWsDeJSUXqvHhxuTLmEh6bKvk0YxLL7aQdd7IaWm7iTdOfF9Sdw2EJ6oZwpjOicqf8SX0LL3AL1RHjc0ec2bvXKXoajNVsRDBLQLRUFLtPsmde%2FuAbwIb2t891WsZ2KXMBjzKrDJYPjjEFp7jaBNeWGhtLRGzF2g7BR4x2yrGP%2B4lMAOB57B9k72wZtlW9AObOpnbrQ5OGDPHMw%3D%3D&needDecode=1") else {
            return
        }
